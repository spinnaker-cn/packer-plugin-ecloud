...
require (
	...
	gitlab.ecloud.com/ecloud/ecloudsdkecs v1.0.21
	gitlab.ecloud.com/ecloud/ecloudsdkims v1.0.11
	gitlab.ecloud.com/ecloud/ecloudsdkvpc v1.0.5
)
